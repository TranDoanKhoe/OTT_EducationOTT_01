                    ...
                    <div className="flex-shrink-0 mr-3">
                      {request.avatar ? (
                        ...
                        <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-lg font-semibold text-white">
                          {(request.name || request.lastName || "U")
                            .charAt(0)
                            .toUpperCase()}
                        </div>
                      )}
              ...
              >
                ...
                <div className="flex-shrink-0 mr-3 relative">
                  {contact.avatar ? (
                    ...
                    >
                      {contact.isGroup ? (
                        <FaChalkboardTeacher size={22} className="text-white" />
                      ) : (
                        <span className="text-white font-semibold text-lg">
                          {(contact.username || contact.name || "U")
                            .charAt(0)
                            .toUpperCase()}
                        </span>
                      )}
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5 mb-0.5">
                    {contact.isPinned && (
                      <BiPin size={14} className="text-amber-500" />
                    )}
                    {contact.isGroup && (
                  ...
                  >
                    {contact.lastMessage?.trim() || "Chưa có tin nhắn"}
                  </div>
                </div>
